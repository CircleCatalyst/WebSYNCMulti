...
public class PHPSerializer {
    ...
    private static int writeObject(ByteArrayOutputStream stream, Object obj, HashMap ht, int hv, String charset) {
        ...
        if (obj instanceof java.io.Serializable) {
            ...
            if (obj instanceof nz.dataview.websyncclient.Serializable) {
                byte[] cs = ((nz.dataview.websyncclient.Serializable) obj).serialize();
    ...
    private static UnSerializeResult readCustomObject(ByteArrayInputStream stream, HashMap ht, int hv, String charset) throws UnSerializeException {
        ...
        ht.put(hv++, o);
        if (o instanceof nz.dataview.websyncclient.Serializable) {
            byte[] b = new byte[n];

            stream.read(b, 0, n);
            ((nz.dataview.websyncclient.Serializable) o).unserialize(b);
        } else {
            stream.skip(n);
        }
        stream.skip(1);
